...
@Component({
    selector: 'app-user-work-items',
    templateUrl: './user-work-items.component.html',
    styleUrls: ['./user-work-items.component.scss']
})
export class UserWorkItemsComponent implements OnInit {
    ...
    getWorkItemListForLoggedInUser() {
        ...
        this.taskManagementService.getWorkItemsForUser(false, this.workItemFilters, pageEvent).subscribe(workItems => {
